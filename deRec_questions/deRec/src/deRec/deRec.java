...
public class deRec extends Applet {
	...
	boolean verify_answers = false;
	boolean verify_answer1 = false;
	boolean verify_answer2 = false;
	boolean verify_answer3 = false;
	boolean verify_answer4 = false;
	boolean verify_answer5 = false;
	
	
	short good_answers=0;
	
	 short QUORUM_ANSWERS = 2;
	...
	public deRec()
	{
		...
		//we will store shares up to 4096 bytes
		share_buffer= new byte[4096];
		
		 question1= new byte[256];
		 answer1= new byte[256];
		 question2= new byte[256];
		 answer2= new byte[256];
		 question3= new byte[256];
		 answer3= new byte[256];
		 question4= new byte[256];
		 answer4= new byte[256];
		 question5= new byte[256];
		 answer5= new byte[256];
	...
	public void deselect()
	{
		//transient
		 ...
		 verify_answer1 = false;
		 verify_answer2 = false;
		 verify_answer3 = false;
		 verify_answer4 = false;
		 verify_answer5 = false;
	}
...
tagSize - the size in in bytes of the authentication tag
	...
	private void get_secret(APDU apdu) {
		
		byte[] buf = apdu.getBuffer();
		
		if(verify_answers != true)
		{
			ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
		}
		else
		{
			Util.arrayCopy(our_secret, (short)0x00, buf, (short)0x00, (short)8);
			apdu.setOutgoingAndSend((short)0x00, (short)8);
		}
	}

	private void get_q(APDU apdu) {
byte[] buf = apdu.getBuffer();
		...
		switch(P1)
		{
			...
			Util.arrayCopy(question1, (short) 0x00 , buf , (short)0x00,(short) 256);
			
			break;
			
			case 0x02:
				
				Util.arrayCopy(question2, (short) 0x00 , buf , (short)0x00,(short) 256);
				
				break;
				
			case 0x03:
				
				Util.arrayCopy(question3, (short) 0x00 , buf , (short)0x00,(short) 256);
				
				break;
			
			case 0x04:
				
				Util.arrayCopy(question4, (short) 0x00 , buf , (short)0x00,(short) 256);
				
				break;
				
			case 0x05:
				
				Util.arrayCopy(question5, (short) 0x00 , buf , (short)0x00,(short) 256);
	...
	private void verify_qa(APDU apdu) {
		
byte[] buf = apdu.getBuffer();
		
		byte P1= buf[ISO7816.OFFSET_P1];
		
		byte L = buf[ISO7816.OFFSET_LC];
		...
		case 0x01:
			...
			if(verify_answer1 ==true)
			{
				ISOException.throwIt(ISO7816.SW_COMMAND_NOT_ALLOWED);
			}
			
		if(	Util.arrayCompare(buf, ISO7816.OFFSET_CDATA, answer1, (short)0x00, (short) L) ==0)
		{
			good_answers ++;
		...
		case 0x02:
			...
			if(verify_answer2 ==true)
			{
				ISOException.throwIt(ISO7816.SW_COMMAND_NOT_ALLOWED);
			}
			
			if(	Util.arrayCompare(buf, ISO7816.OFFSET_CDATA, answer2, (short)0x00, (short) L) ==0)
			{
				good_answers ++;
		...
		case 0x03:
			...
			if(verify_answer3 ==true)
			{
				ISOException.throwIt(ISO7816.SW_COMMAND_NOT_ALLOWED);
			}
			
			if(	Util.arrayCompare(buf, ISO7816.OFFSET_CDATA, answer3, (short)0x00, (short) L) ==0)
			{
				good_answers ++;
		...
		case 0x04:
			...
			if(verify_answer4 ==true)
			{
				ISOException.throwIt(ISO7816.SW_COMMAND_NOT_ALLOWED);
			}
			
			
			if(	Util.arrayCompare(buf, ISO7816.OFFSET_CDATA, answer4, (short)0x00, (short) L) ==0)
			{
				good_answers ++;
		...
		case 0x05:
			...
			if(verify_answer5 ==true)
			{
				ISOException.throwIt(ISO7816.SW_COMMAND_NOT_ALLOWED);
			}
			
			
			if(	Util.arrayCompare(buf, ISO7816.OFFSET_CDATA, answer5, (short)0x00, (short) L) ==0)
			{
				good_answers ++;
			...
			if(good_answers >= QUORUM_ANSWERS )
			{
				//jackpot!
				verify_answers = true;
			}
	...
	private void store_qa(APDU apdu) {
		...
		case 0x01:
			...
			if(P2 == 0x00)
			{
				Util.arrayFill(question1, (short)0, (short)256,(byte)0x00);
				//question
				Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,question1, (short)0x00,(short) L);
				
			}
			else if(P2 == 0x01)
			{
				Util.arrayFill(answer1, (short)0, (short)256,(byte)0x00);
				//answer
				Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,answer1, (short)0x00,(short) L);
			}
			else
			{
			ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
...
case 0x02:
			...
			if(P2 == 0x00)
			{
				Util.arrayFill(question2, (short)0, (short)256,(byte)0x00);
				//question
				Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,question2, (short)0x00,(short) L);
				
			}
			else if(P2 == 0x01)
			{
				Util.arrayFill(answer2, (short)0, (short)256,(byte)0x00);
				//answer
				Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,answer2, (short)0x00,(short) L);
			}
			else
			{
			ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
...
case 0x03:
	...
	if(P2 == 0x00)
	{
		Util.arrayFill(question3, (short)0, (short)256,(byte)0x00);
		//question
		Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,question3, (short)0x00,(short) L);
		
	}
	else if(P2 == 0x01)
	{
		Util.arrayFill(answer3, (short)0, (short)256,(byte)0x00);
		//answer
		Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,answer3, (short)0x00,(short) L);
	}
	else
	{
	ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
...
case 0x04:
	...
	if(P2 == 0x00)
	{
		Util.arrayFill(question4, (short)0, (short)256,(byte)0x00);
		//question
		Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,question4, (short)0x00,(short) L);
		
	}
	else if(P2 == 0x01)
	{
		Util.arrayFill(answer4, (short)0, (short)256,(byte)0x00);
		//answer
		Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,answer4, (short)0x00,(short) L);
	}
	else
	{
	ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
...
case 0x05:
	...
	if(P2 == 0x00)
	{
		Util.arrayFill(question5, (short)0, (short)256,(byte)0x00);
		//question
		Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,question5, (short)0x00,(short) L);
		
	}
	else if(P2 == 0x01)
	{
		Util.arrayFill(answer5, (short)0, (short)256,(byte)0x00);
		//answer
		Util.arrayCopy(buf, ISO7816.OFFSET_CDATA,answer5, (short)0x00,(short) L);
	}
	else
	{
	ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
	...
	private void receiveAndSendEncryptedMessage(APDU apdu) {
		...
		//next we check what the message is
		
		//shares are split themselves into n pieces
		//first byte is share number
		//second byte is total number of split of share
		//third byte is the number of split of share
		//the remaining 13 bytes are the share split content
		byte[] buf= apdu.getBuffer();
		//P1=01
		//We get shares to store (encrypted message)
		if(buf[ISO7816.OFFSET_P1]==0x01)
		{
			
			
			share_number=their_message[(short)0x00];
			share_split=their_message[(short)0x01];
			share_index=their_message[(short)0x02];
			
			if((byte)(share_index+1)>share_split)
			{
				ISOException.throwIt(ISO7816.SW_WRONG_LENGTH);
			}
			if((short)(13*share_split)> (short)4096)
			{
			...
			try
			{
			Util.arrayCopy(their_message, (short)3, share_buffer, (short)(13*share_index), (short)13);
			}
			catch(Exception ex)
			{
		...
		//P1=02
		//We must send back the shares
		if(buf[ISO7816.OFFSET_P1]==0x02)
		{
			if(share_number!=their_message[(short)0x00])
			{
				ISOException.throwIt(ISO7816.SW_WRONG_DATA);
			}
					
					
	        my_message[(short)0x00]=share_number;
			share_split=their_message[(short)0x01];
			my_message[(short)0x01]=share_split;
			share_index=their_message[(short)0x02];
			my_message[(short)0x02]=share_index;
			...
			try
			{
			Util.arrayCopy(share_buffer, (short)(13*share_index), my_message, (short)3, (short)13);
			}
			catch(Exception ex)
			{
				ISOException.throwIt((short)0x1234);
